...
<nav class="navbar navbar-expand-lg navbar-light bg-dark bg-gradient" >
  <div class="container" >
    <img src="styleclothingr.png" width="30%">
    <span class="navbar-brand text-light text-shadow"><?php echo $_SESSION['usuario'];?><?php echo $_SESSION['descripcion'];?></span>
	
    <a class="navbar-brand text-light text-shadow" href="../dist/index.php">Regresar</a>
  </div>
</nav>
                ...
                <table class="table table-hover table-bordered table-striped" id="authors-tbl">
                    <thead>
                        <tr class="bg-dark text-light bg-gradient bg-opacity-150">
                            <th class="px-1 py-1 text-center">Imagen</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Agregar Ropa:</h5>
    ...
    <div class="modal fade" id="edit_modal" data-bs-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Editar detalles de la ropa:</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="container-fluid">
